...
- Online TONE3000 search and download use the A2 model lane by default. Support can expose a browser **Use A2 models** toggle for switching to the original NAM model lane; both lanes can live on disk together.
