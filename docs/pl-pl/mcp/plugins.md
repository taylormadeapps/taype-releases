...
Narzędzia for managing VST3 plugin inserts and the Mix FX bus.
...
```json
{
  "enabled": false,
  "plugin_loaded": false,
  "plugin_name": "Tape Multi Ścieżka",
  "available": true
}
```
...
Włącz or disable tape summing. Requires transport stopped.
...
Otwórz the Softube Tape plugin editor window.
