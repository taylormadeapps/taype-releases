...
```json
{
  ...
  "directory": "/Users/.../Documents/TayPE/NAM/Przedwzmacniacze",
  "count": 1
}
```
...
| `drive` | number | no | Wejście drive in dB (default: 0.0) |
| `output_gain` | number | no | Wyjście gain in dB (default: 0.0) |
