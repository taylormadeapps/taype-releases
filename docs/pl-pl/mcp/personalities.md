...
Osobowości are studio tech characters that shape how an AI assistant
...
| Name | Vibe |
|------|------|
| **Glue & Weight** | Szyna-first thinking, compression, cohesion. The default. |
| **Arena Push** | Bold, assertive, stadium-sized mixes |
| **Polished Depth** | Dimensional, elegant, radio-ready polish |
| **Intimate Front** | Zamknij, textured, honest - lo-fi meets intention |
...
## What Osobowości Can and Cannot Do

Osobowości shape tone, suggestions, and workflow defaults. They never
