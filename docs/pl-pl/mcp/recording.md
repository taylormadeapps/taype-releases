...
Narzędzia for recording audio input.
...
|-------|------|----------|-------------|
| `track_id` | string | yes | Ścieżka to record onto |

**Returns:** `{ "recording": true, "track_id": "track_2", "position": 5.0 }`

### `record_stop`

Zatrzymaj recording, finalize the WAV file, add the recorded clip to the track, and
