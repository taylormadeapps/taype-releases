...
TONE3000 rows show the model thumbnail, type, creator, architecture, and an AMX badge for LSTM/AMX-compatible captures. Use the **Widok Profil** link at the bottom right of a row to open its page on tone3000.com.
