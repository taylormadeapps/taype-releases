...
Right-click in the upper ruler area to open the zero-point menu for the selected Wytnij.
...
Markery belong to the current Wytnij and stay fixed to absolute timeline time.
Changing tempo, time signature, or the Wytnij zero point does not move them.

- Right-click the top ruler area and choose **Dodaj Marker at Playhead** to drop
...
- Double-click a marker tab to name it. If you leave the name blank, TayPE
  shows the marker's current index instead. Zmień nazwę is allowed during playback,
