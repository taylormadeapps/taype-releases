...
- A few minutes to set up two macOS Shortcuts
...
2. Create a new shortcut and name it **Tape Talkback**
3. Add a **Dictate Text** action
   - Set "Stop listening" to **After Pause**
4. Add a **Run AppleScript** action and paste the studio mode script
   (see "The Scripts" below)
5. Save the shortcut
6. Click the **info button** at the top right of the shortcut editor
7. Click **Add Keyboard Shortcut** and press **⌘⌥↩**
   (Cmd + Option + Return)
...
1. Create another shortcut and name it **Tape Brain**
2. Add a **Dictate Text** action
   - Set "Stop listening" to **After Pause**
3. Add a **Run AppleScript** action and paste the brain mode script
   (see "The Scripts" below)
4. Save the shortcut
5. Click the **info button** and click **Add Keyboard Shortcut**
...
2. Make sure **Shortcuts** is in the list and turned on
...
Paste this into the Run AppleScript action of your **Tape Talkback**
shortcut:
...
Paste this into the Run AppleScript action of your **Tape Brain**
shortcut:
...
shortcut. Speak: "what's a good EQ approach for a room mic". Focus
...
1. Turn on **Voice Control** in System Settings → Accessibility
2. Create a custom voice command (e.g. say "talkback") that runs
