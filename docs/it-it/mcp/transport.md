...
timeline, and a device sample rate che matches the reel.
...
Ripristina the selected Cut's zero point back to timeline start.
...
Abilita or disable the metronome click.
