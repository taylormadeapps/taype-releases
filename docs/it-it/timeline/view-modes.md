...
|----------|------|-------------|
| F | Focus | Show only tracks con clips at the tape head while it moves |
...
Fai clic con il pulsante destro the ruler **A** button to choose whether the automation overlay
