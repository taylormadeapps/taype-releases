...
TayPE è costruito attorno a un semplice loop: registra, ascolta, conferma. No endless
menus, no buried features. Ecco come il flusso di lavoro principale si adatta insieme.

## Le Due Visualizzazioni

TayPE ha due visualizzazioni principali. Premi **M** per passare da una all'altra.

**Linea Temporale** - dove vedi le tue tracce, i clip e la testina di lettura che si muove
nel tempo. Qui è dove registri, organizzi e modifichi.

**Mixer** - dove modelli il suono. Faders, EQ, compression, plugin
inserts. One channel strip per track, laid out left to right.

## Apertura e Creazione di Bobine

TayPE si apre nel **Browser Bobine**. That is the place to open an existing
...
Usa **Apri da File...** nel Browser Bobine quando la bobina o il pacchetto che desideri
è al di fuori della tua libreria normale.

Fai clic con il pulsante destro su una bobina nel browser per **Rinominare** o **Eliminare**. TayPE asks
...
dentro la cartella Bobine. After delete, TayPE confirms the move and offers
**Show in Finder** so you can reveal la bobina spostata con quel bundle selezionato.

Quando una bobina è già aperta, la riga dell'azione del browser inizia con **Media**,
che apre la cartella `media/` di quella bobina in Finder senza chiudere il browser.
...
`[TAPE_HOME]/Reels` and suggests a bundle name like
