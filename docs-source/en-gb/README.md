...
* [The Timeline](timeline/) for recording, editing, markers, track headers, and view modes.
* [The Mixer](mixer.md) and [Channel Strip](channel-strip/) for mixing, routing, inserts, meters, and stock processors.
* [Reels](reels/) for saving, checkpoints, packing, thinning, and upgrades.
* [MCP Integration](mcp/) if you want an AI client or script to drive TayPE.
