...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "TayPE’s arranger is deliberately lean, but it’s not a toy.",
            "arranger-flow-copy-2": "Edit audio directly on the timeline. Move, trim and shape performances with the speed and precision demanded by professional recording workflows, without getting buried under windows, dialogs and endless configuration.",
            "arranger-flow-copy-3": "Record software instruments as audio while keeping the original MIDI performance attached as a sidecar. Capture the sound that inspired the take while retaining the freedom to change notes, timing or instrumentation later.",
            "arranger-flow-copy-4": "Commit to sound without committing forever.",
            "arranger-flow-copy-5": "If Melodyne is installed, it’s available wherever you need it. Open any clip and start editing immediately — no dedicated tracks, no plugin management, no setup ritual.",
            "arranger-flow-copy-6": "TayPE includes the “Industry Standard” keybinding profile for producers whose workflows are already committed to wetware. Prefer something else? Every shortcut is configurable, so you’re free to build your own.",
            "arranger-flow-copy-7": "The result is a workflow that stays creative when you’re writing and stays flexible when you’re producing.",
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "TayPEのアレンジャーは意図的にリーンですが、おもちゃではありません。",
            "arranger-flow-copy-2": "タイムライン上でオーディオを直接編集できます。プロフェッショナルな録音ワークフローが求める速度と精度で、演奏を移動、トリム、整形し、ウィンドウやダイアログ、終わりのない設定に埋もれません。",
            "arranger-flow-copy-3": "ソフトウェア音源をオーディオとして録音しながら、元のMIDI演奏をサイドカーとして残せます。そのテイクを生んだ音をキャプチャしつつ、あとからノート、タイミング、音源を変える自由を保てます。",
            "arranger-flow-copy-4": "音にはコミットする。でも永遠に縛られない。",
            "arranger-flow-copy-5": "Melodyneがインストールされていれば、必要な場所ですぐ使えます。任意のクリップを開いてすぐ編集 — 専用トラックも、プラグイン管理も、準備儀式も不要。",
            "arranger-flow-copy-6": "TayPEには、制作ワークフローがすでに体に染み込んでいるプロデューサー向けに「Industry Standard」キー割り当てプロファイルが含まれます。別のやり方が好みなら、すべてのショートカットを設定できます。",
            "arranger-flow-copy-7": "その結果、書いているときは創造的で、制作しているときは柔軟なままのワークフローになります。",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "L’arrangeur de TayPE est volontairement épuré, mais ce n’est pas un jouet.",
            "arranger-flow-copy-2": "Éditez l’audio directement sur la timeline. Déplacez, rognez et façonnez les performances avec la vitesse et la précision exigées par les workflows d’enregistrement professionnels, sans vous retrouver enseveli sous des fenêtres, des dialogues et une configuration sans fin.",
            "arranger-flow-copy-3": "Enregistrez les instruments logiciels en audio tout en conservant la performance MIDI d’origine comme sidecar. Capturez le son qui a inspiré la prise tout en gardant la liberté de modifier les notes, le timing ou l’instrumentation plus tard.",
            "arranger-flow-copy-4": "Engagez-vous sur le son sans vous enfermer pour toujours.",
            "arranger-flow-copy-5": "Si Melodyne est installé, il est disponible là où vous en avez besoin. Ouvrez n’importe quel clip et commencez à éditer immédiatement — pas de pistes dédiées, pas de gestion de plugins, pas de rituel de configuration.",
            "arranger-flow-copy-6": "TayPE inclut le profil de raccourcis « Industry Standard » pour les producteurs dont les gestes sont déjà inscrits dans les automatismes. Vous préférez autre chose ? Chaque raccourci est configurable, pour construire votre propre façon de travailler.",
            "arranger-flow-copy-7": "Le résultat : un flux qui reste créatif quand vous écrivez et flexible quand vous produisez.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "de-de": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "Der Arranger von TayPE ist bewusst schlank, aber kein Spielzeug.",
            "arranger-flow-copy-2": "Bearbeite Audio direkt auf der Timeline. Verschiebe, trimme und forme Performances mit der Geschwindigkeit und Präzision, die professionelle Aufnahme-Workflows verlangen, ohne unter Fenstern, Dialogen und endloser Konfiguration begraben zu werden.",
            "arranger-flow-copy-3": "Nimm Software-Instrumente als Audio auf und behalte die ursprüngliche MIDI-Performance als Sidecar. Fange den Sound ein, der den Take inspiriert hat, und behalte trotzdem die Freiheit, Noten, Timing oder Instrumentierung später zu ändern.",
            "arranger-flow-copy-4": "Leg dich auf den Sound fest, ohne dich für immer festzulegen.",
            "arranger-flow-copy-5": "Wenn Melodyne installiert ist, ist es verfügbar, wo du es brauchst. Öffne einen Clip und beginne sofort zu bearbeiten — keine dedizierten Spuren, keine Plugin-Verwaltung, kein Einrichtungsritual.",
            "arranger-flow-copy-6": "TayPE enthält das Tastaturprofil „Industry Standard“ für Produzenten, deren Workflows schon im Muskelgedächtnis sitzen. Lieber etwas anderes? Jeder Shortcut ist konfigurierbar, damit du deinen eigenen bauen kannst.",
            "arranger-flow-copy-7": "Das Ergebnis ist ein Workflow, der beim Schreiben kreativ bleibt und beim Produzieren flexibel bleibt.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "es-es": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "El arranger de TayPE es deliberadamente ligero, pero no es un juguete.",
            "arranger-flow-copy-2": "Edita audio directamente en la línea de tiempo. Mueve, recorta y da forma a las interpretaciones con la velocidad y precisión que exigen los flujos de grabación profesionales, sin quedar enterrado bajo ventanas, diálogos y configuración interminable.",
            "arranger-flow-copy-3": "Graba instrumentos software como audio mientras conservas la interpretación MIDI original como sidecar. Captura el sonido que inspiró la toma y mantén la libertad de cambiar notas, timing o instrumentación más tarde.",
            "arranger-flow-copy-4": "Comprométete con el sonido sin comprometerte para siempre.",
            "arranger-flow-copy-5": "Si Melodyne está instalado, estará disponible donde lo necesites. Abre cualquier clip y empieza a editar inmediatamente — sin pistas dedicadas, sin gestión de plugins, sin ritual de configuración.",
            "arranger-flow-copy-6": "TayPE incluye el perfil de atajos «Industry Standard» para productores cuyos flujos ya están fijados en la memoria muscular. ¿Prefieres otra cosa? Todos los atajos son configurables, así que puedes construir el tuyo.",
            "arranger-flow-copy-7": "El resultado es un flujo que sigue siendo creativo cuando escribes y flexible cuando produces.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "is-is": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "Arranger TayPE er meðvitað einfaldur, en hann er ekki leikfang.",
            "arranger-flow-copy-2": "Breyttu hljóði beint á tímalínunni. Færðu, klipptu og mótaðu flutning með þeim hraða og nákvæmni sem fagleg upptökuvinnuflæði krefjast, án þess að týnast í gluggum, samtölum og endalausum stillingum.",
            "arranger-flow-copy-3": "Taktu hugbúnaðarhljóðfæri upp sem hljóð en haltu upprunalega MIDI-flutningnum sem sidecar. Fangar hljóðið sem kveikti tökuna, en heldur frelsinu til að breyta nótum, tímasetningu eða hljóðfærum síðar.",
            "arranger-flow-copy-4": "Skuldbittu þig við hljóðið án þess að skuldbinda þig að eilífu.",
            "arranger-flow-copy-5": "Ef Melodyne er uppsett er það tiltækt hvar sem þú þarft á því að halda. Opnaðu hvaða klippu sem er og byrjaðu strax að vinna — engar sérstakar rásir, engin viðbótastjórnun, enginn uppsetningarathöfn.",
            "arranger-flow-copy-6": "TayPE inniheldur „Industry Standard“ flýtilyklasniðið fyrir pródúsenta sem hafa þegar fest vinnuflæðið í vöðvaminni. Viltu eitthvað annað? Hver flýtilykill er stillanlegur, svo þú getur byggt þitt eigið.",
            "arranger-flow-copy-7": "Útkoman er vinnuflæði sem heldur sér skapandi þegar þú semur og sveigjanlegt þegar þú framleiðir.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "De arranger van TayPE is bewust lean, maar het is geen speelgoed.",
            "arranger-flow-copy-2": "Bewerk audio direct op de tijdlijn. Verplaats, trim en vorm performances met de snelheid en precisie die professionele opnameworkflows vragen, zonder begraven te raken onder vensters, dialogen en eindeloze configuratie.",
            "arranger-flow-copy-3": "Neem software-instrumenten op als audio terwijl de originele MIDI-performance als sidecar bewaard blijft. Leg het geluid vast dat de take inspireerde en behoud de vrijheid om later noten, timing of instrumentatie te veranderen.",
            "arranger-flow-copy-4": "Commit aan het geluid zonder je voor altijd vast te leggen.",
            "arranger-flow-copy-5": "Als Melodyne is geïnstalleerd, is het beschikbaar waar je het nodig hebt. Open elke clip en begin meteen met bewerken — geen speciale tracks, geen pluginbeheer, geen setup-ritueel.",
            "arranger-flow-copy-6": "TayPE bevat het toetsprofiel “Industry Standard” voor producers wier workflows al in het spiergeheugen zitten. Liever iets anders? Elke sneltoets is configureerbaar, dus je kunt je eigen bouwen.",
            "arranger-flow-copy-7": "Het resultaat is een workflow die creatief blijft wanneer je schrijft en flexibel blijft wanneer je produceert.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "it-it": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "L’arranger di TayPE è volutamente snello, ma non è un giocattolo.",
            "arranger-flow-copy-2": "Modifica l’audio direttamente sulla timeline. Sposta, ritaglia e modella le performance con la velocità e la precisione richieste dai workflow di registrazione professionali, senza finire sepolto sotto finestre, dialoghi e configurazioni infinite.",
            "arranger-flow-copy-3": "Registra gli strumenti software come audio mantenendo la performance MIDI originale come sidecar. Cattura il suono che ha ispirato la take e conserva la libertà di cambiare note, timing o strumentazione più tardi.",
            "arranger-flow-copy-4": "Impegnati sul suono senza impegnarti per sempre.",
            "arranger-flow-copy-5": "Se Melodyne è installato, è disponibile ovunque serva. Apri qualunque clip e inizia subito a modificare — niente tracce dedicate, niente gestione plugin, niente rituale di setup.",
            "arranger-flow-copy-6": "TayPE include il profilo di scorciatoie “Industry Standard” per producer i cui workflow sono già fissati nella memoria muscolare. Preferisci altro? Ogni scorciatoia è configurabile, così puoi costruirti la tua.",
            "arranger-flow-copy-7": "Il risultato è un workflow che resta creativo mentre scrivi e flessibile mentre produci.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "pl-pl": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "Aranżer TayPE jest celowo prosty, ale to nie zabawka.",
            "arranger-flow-copy-2": "Edytuj audio bezpośrednio na osi czasu. Przesuwaj, przycinaj i kształtuj wykonania z szybkością i precyzją wymaganą przez profesjonalne workflow nagraniowe, bez zasypywania oknami, dialogami i niekończącą się konfiguracją.",
            "arranger-flow-copy-3": "Nagrywaj instrumenty programowe jako audio, zachowując oryginalne wykonanie MIDI jako sidecar. Uchwyć brzmienie, które zainspirowało take, a jednocześnie zachowaj swobodę późniejszej zmiany nut, timingu lub instrumentacji.",
            "arranger-flow-copy-4": "Zobowiąż się do brzmienia, nie zobowiązując się na zawsze.",
            "arranger-flow-copy-5": "Jeśli Melodyne jest zainstalowany, jest dostępny tam, gdzie go potrzebujesz. Otwórz dowolny klip i od razu zacznij edycję — bez dedykowanych ścieżek, zarządzania pluginami i rytuału konfiguracji.",
            "arranger-flow-copy-6": "TayPE zawiera profil skrótów „Industry Standard” dla producentów, których workflow jest już zapisany w pamięci mięśniowej. Wolisz coś innego? Każdy skrót można skonfigurować, więc możesz zbudować własny.",
            "arranger-flow-copy-7": "Efektem jest workflow, który pozostaje kreatywny podczas pisania i elastyczny podczas produkcji.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "uk-ua": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "Аранжувальник TayPE навмисно лаконічний, але це не іграшка.",
            "arranger-flow-copy-2": "Редагуйте аудіо прямо на таймлайні. Переміщуйте, обрізайте й формуйте виконання зі швидкістю та точністю, яких вимагають професійні recording workflow, без занурення у вікна, діалоги й нескінченні налаштування.",
            "arranger-flow-copy-3": "Записуйте програмні інструменти як аудіо, зберігаючи оригінальне MIDI-виконання як sidecar. Захоплюйте звук, який надихнув тейк, і водночас зберігайте свободу пізніше змінити ноти, таймінг або інструментування.",
            "arranger-flow-copy-4": "Фіксуйте звук, не фіксуючи себе назавжди.",
            "arranger-flow-copy-5": "Якщо Melodyne встановлено, він доступний там, де потрібен. Відкрийте будь-який кліп і починайте редагувати одразу — без спеціальних доріжок, керування плагінами й ритуалу налаштування.",
            "arranger-flow-copy-6": "TayPE містить профіль гарячих клавіш «Industry Standard» для продюсерів, чиї workflow вже закріплені в м’язовій пам’яті. Хочете інакше? Кожне скорочення можна налаштувати, тож ви можете зібрати власне.",
            "arranger-flow-copy-7": "Результат — workflow, який лишається творчим під час написання і гнучким під час продакшну.",
            "screenshots-laforge-heading": "LaForgé",
    ...
    "el-gr": {
        ...
        text: {
            ...
            "arranger-flow-copy-1": "Ο arranger του TayPE είναι σκόπιμα λιτός, αλλά δεν είναι παιχνίδι.",
            "arranger-flow-copy-2": "Επεξεργαστείτε audio απευθείας στο timeline. Μετακινήστε, κόψτε και διαμορφώστε εκτελέσεις με την ταχύτητα και ακρίβεια που απαιτούν τα επαγγελματικά recording workflows, χωρίς να θαφτείτε κάτω από παράθυρα, διαλόγους και ατελείωτες ρυθμίσεις.",
            "arranger-flow-copy-3": "Ηχογραφήστε software instruments ως audio, κρατώντας την αρχική MIDI εκτέλεση ως sidecar. Πιάστε τον ήχο που ενέπνευσε το take, διατηρώντας την ελευθερία να αλλάξετε νότες, timing ή instrumentation αργότερα.",
            "arranger-flow-copy-4": "Δεσμευτείτε στον ήχο χωρίς να δεσμευτείτε για πάντα.",
            "arranger-flow-copy-5": "Αν το Melodyne είναι εγκατεστημένο, είναι διαθέσιμο όπου το χρειάζεστε. Ανοίξτε οποιοδήποτε clip και ξεκινήστε αμέσως την επεξεργασία — χωρίς dedicated tracks, χωρίς διαχείριση plugin, χωρίς τελετουργία setup.",
            "arranger-flow-copy-6": "Το TayPE περιλαμβάνει το προφίλ συντομεύσεων «Industry Standard» για παραγωγούς των οποίων τα workflows είναι ήδη γραμμένα στη μυϊκή μνήμη. Προτιμάτε κάτι άλλο; Κάθε shortcut είναι παραμετροποιήσιμο, ώστε να χτίσετε το δικό σας.",
            "arranger-flow-copy-7": "Το αποτέλεσμα είναι ένα workflow που μένει δημιουργικό όταν γράφετε και ευέλικτο όταν παράγετε.",
            "screenshots-laforge-heading": "LaForgé",
