...
const DOWNLOAD_URL = "https://github.com/taylormadeapps/taype-releases/releases/download/v0.20.0/Taype-0.20.0.pkg";
...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment exists to help you make the record, not drown in endless options. A multitrack DAW with the soul of a tape machine. Fewer modes, fewer knobs, more truth.",
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment は、無限の選択肢に溺れるためではなく、レコードを作るためにあります。テープマシンの魂を持ったマルチトラック DAW。モードは少なく、ノブも少なく、真実は多く。",
            "screenshots-tape-heading": "The Tape",
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment existe pour vous aider à faire le disque, pas à vous noyer dans des options sans fin. Une DAW multipiste avec l'âme d'un magnétophone. Moins de modes, moins de boutons, plus de vérité.",
            "screenshots-tape-heading": "The Tape",
    ...
    "de-de": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment ist dafür da, dir beim Machen der Platte zu helfen, nicht beim Ertrinken in endlosen Optionen. Eine Multitrack-DAW mit der Seele einer Bandmaschine. Weniger Modi, weniger Knöpfe, mehr Wahrheit.",
            "screenshots-tape-heading": "The Tape",
    ...
    "es-es": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment existe para ayudarte a hacer el disco, no a ahogarte en opciones infinitas. Una DAW multipista con alma de grabadora de cinta. Menos modos, menos perillas, más verdad.",
            "screenshots-tape-heading": "The Tape",
    ...
    "is-is": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment er til að hjálpa þér að gera plötuna, ekki sökkva í endalausa valkosti. Fjölrása DAW með sál segulbandstækis. Færri hamir, færri hnappar, meiri sannleikur.",
            "screenshots-tape-heading": "The Tape",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment helpt je de plaat te maken, niet te verdrinken in eindeloze opties. Een multitrack DAW met het hart van een bandapparaat. Minder modi, minder knoppen, meer waarheid.",
            "screenshots-tape-heading": "The Tape",
    ...
    "it-it": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment esiste per aiutarti a fare il disco, non per annegare in opzioni infinite. Una DAW multitraccia con l'anima di un registratore. Meno modalità, meno manopole, più verità.",
            "screenshots-tape-heading": "The Tape",
    ...
    "pl-pl": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment istnieje, aby pomóc ci zrobić płytę, a nie tonąć w nieskończonych opcjach. Wielościeżkowy DAW z duszą magnetofonu. Mniej trybów, mniej gałek, więcej prawdy.",
            "screenshots-tape-heading": "The Tape",
    ...
    "uk-ua": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Taylor's Performance Environment існує, щоб допомогти вам зробити запис, а не потонути в безкінечних опціях. Багатодоріжковий DAW з душею магнітофона. Менше режимів, менше кнопок, більше правди.",
            "screenshots-tape-heading": "The Tape",
    ...
    "el-gr": {
        ...
        text: {
            ...
            "philosophy-copy-1": "Το Taylor's Performance Environment υπάρχει για να σας βοηθήσει να φτιάξετε τον δίσκο, όχι να πνιγείτε σε ατελείωτες επιλογές. Ένα πολυτροχικό DAW με την ψυχή μιας ταινιογραφικής μηχανής. Λιγότερες λειτουργίες, λιγότερα κουμπιά, περισσότερη αλήθεια.",
            "screenshots-tape-heading": "The Tape",
