...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familiar on the surface. Radical underneath.",
            "hero-manifesto-copy-1": "Taype takes the familiar language of the recording studio and rebuilds it for a post-technical world. The critical engineering decisions have been made ahead of time, so you can focus on making the record.",
            "hero-manifesto-copy-2": "It takes a freeze-first approach to software and hardware instruments, with the MIDI embedded in the audio clip, always close at hand. And it’s designed to connect openly with other next-generation tools, rather than replace the human element.",
            "hero-cta": "Let's Roll",
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "表面は親しみやすく。内側は革新的。",
            "hero-manifesto-copy-1": "Taype はレコーディングスタジオでおなじみの言葉を受け継ぎ、ポストテクニカルな世界のために組み直します。重要なエンジニアリング上の判断はあらかじめ済ませてあるので、あなたはレコード作りに集中できます。",
            "hero-manifesto-copy-2": "ソフトウェア／ハードウェア音源にはフリーズを前提としたアプローチを取り、MIDI はオーディオクリップに埋め込まれ、いつでもすぐ手に取れます。そして、人間の役割を置き換えるのではなく、ほかの次世代ツールと開かれた形でつながるよう設計されています。",
            "hero-cta": "さあ始めよう",
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familier en surface. Radical en profondeur.",
            "hero-manifesto-copy-1": "Taype reprend le langage familier du studio d’enregistrement et le reconstruit pour un monde post-technique. Les décisions d’ingénierie essentielles ont été prises en amont, afin que vous puissiez vous concentrer sur le disque.",
            "hero-manifesto-copy-2": "Pour les instruments logiciels et matériels, Taype adopte une approche freeze-first : le MIDI reste intégré au clip audio, toujours à portée de main. Et Taype est conçu pour se connecter ouvertement aux autres outils de nouvelle génération, plutôt que de remplacer l’élément humain.",
    ...
    "de-de": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Vertraut an der Oberfläche. Radikal darunter.",
            "hero-manifesto-copy-1": "Taype nimmt die vertraute Sprache des Aufnahmestudios und baut sie für eine posttechnische Welt neu auf. Die entscheidenden technischen Entscheidungen sind bereits getroffen, damit du dich darauf konzentrieren kannst, die Platte zu machen.",
            "hero-manifesto-copy-2": "Bei Software- und Hardware-Instrumenten verfolgt Taype einen Freeze-first-Ansatz: Das MIDI bleibt im Audioclip eingebettet und jederzeit griffbereit. Und Taype ist darauf ausgelegt, sich offen mit anderen Werkzeugen der nächsten Generation zu verbinden, statt den menschlichen Anteil zu ersetzen.",
            "hero-cta": "Los geht's",
    ...
    "es-es": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familiar en la superficie. Radical por dentro.",
            "hero-manifesto-copy-1": "Taype toma el lenguaje familiar del estudio de grabación y lo reconstruye para un mundo postécnico. Las decisiones críticas de ingeniería ya están tomadas, para que puedas concentrarte en hacer el disco.",
            "hero-manifesto-copy-2": "Adopta un enfoque freeze-first para instrumentos de software y hardware, con el MIDI integrado en el clip de audio y siempre a mano. Y está diseñado para conectarse abiertamente con otras herramientas de nueva generación, en lugar de sustituir el elemento humano.",
            "hero-cta": "A grabar",
    ...
    "is-is": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Kunnuglegt á yfirborðinu. Róttækt undir niðri.",
            "hero-manifesto-copy-1": "Taype tekur kunnuglegt tungumál upptökuversins og endurbyggir það fyrir heim handan tækninnar. Mikilvægu verkfræðilegu ákvarðanirnar hafa verið teknar fyrirfram, svo þú getir einbeitt þér að því að gera plötuna.",
            "hero-manifesto-copy-2": "Það notar freeze-first nálgun fyrir hugbúnaðar- og vélbúnaðarhljóðfæri, með MIDI gögnin innbyggð í hljóðklippuna og alltaf við höndina. Og það er hannað til að tengjast opinskátt öðrum næstu kynslóðar verkfærum, frekar en að leysa mannlega þáttinn af hólmi.",
            "hero-cta": "Til verks",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Vertrouwd aan de buitenkant. Radicaal vanbinnen.",
            "hero-manifesto-copy-1": "Taype neemt de vertrouwde taal van de opnamestudio en bouwt die opnieuw op voor een posttechnische wereld. De cruciale technische beslissingen zijn vooraf genomen, zodat jij je kunt richten op het maken van de plaat.",
            "hero-manifesto-copy-2": "Voor software- en hardware-instrumenten kiest Taype een freeze-first-aanpak, met de MIDI ingebed in de audioclip en altijd binnen handbereik. En Taype is ontworpen om open verbinding te maken met andere tools van de volgende generatie, in plaats van het menselijke element te vervangen.",
    ...
    "it-it": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familiare in superficie. Radicale dentro.",
            "hero-manifesto-copy-1": "Taype prende il linguaggio familiare dello studio di registrazione e lo ricostruisce per un mondo post-tecnico. Le decisioni tecniche cruciali sono già state prese, così puoi concentrarti sul fare il disco.",
            "hero-manifesto-copy-2": "Adotta un approccio freeze-first agli strumenti software e hardware, con il MIDI incorporato nella clip audio e sempre a portata di mano. Ed è progettato per collegarsi apertamente agli altri strumenti di nuova generazione, invece di sostituire l’elemento umano.",
            "hero-cta": "Si parte",
    ...
    "pl-pl": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Znajome na powierzchni. Radykalne pod spodem.",
            "hero-manifesto-copy-1": "Taype bierze znajomy język studia nagraniowego i buduje go od nowa dla posttechnicznego świata. Kluczowe decyzje inżynieryjne zostały podjęte z wyprzedzeniem, aby można było skupić się na tworzeniu płyty.",
            "hero-manifesto-copy-2": "W przypadku instrumentów programowych i sprzętowych Taype stosuje podejście freeze-first: MIDI jest osadzone w klipie audio i zawsze pozostaje pod ręką. Taype zaprojektowano też tak, aby otwarcie łączył się z innymi narzędziami nowej generacji, zamiast zastępować czynnik ludzki.",
            "hero-cta": "Zaczynamy",
    ...
    "uk-ua": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Знайомий зовні. Радикальний усередині.",
            "hero-manifesto-copy-1": "Taype бере знайому мову студії звукозапису й перебудовує її для посттехнічного світу. Критичні інженерні рішення вже прийняті заздалегідь, тож ви можете зосередитися на створенні запису.",
            "hero-manifesto-copy-2": "Для програмних і апаратних інструментів Taype використовує підхід freeze-first: MIDI вбудовано в аудіокліп і він завжди під рукою. Taype також спроєктовано для відкритого з’єднання з іншими інструментами нового покоління, а не для заміни людського елемента.",
            "hero-cta": "Поїхали",
    ...
    "el-gr": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Οικείο στην επιφάνεια. Ριζοσπαστικό από κάτω.",
            "hero-manifesto-copy-1": "Το Taype παίρνει την οικεία γλώσσα του στούντιο ηχογράφησης και την ξαναχτίζει για έναν μετα-τεχνικό κόσμο. Οι κρίσιμες μηχανικές αποφάσεις έχουν ληφθεί εκ των προτέρων, ώστε να μπορείτε να επικεντρωθείτε στη δημιουργία του δίσκου.",
            "hero-manifesto-copy-2": "Ακολουθεί μια προσέγγιση freeze-first για όργανα λογισμικού και υλικού, με το MIDI ενσωματωμένο στο ηχητικό κλιπ και πάντα διαθέσιμο. Και έχει σχεδιαστεί για να συνδέεται ανοιχτά με άλλα εργαλεία επόμενης γενιάς, αντί να αντικαθιστά τον ανθρώπινο παράγοντα.",
            "hero-cta": "Ξεκινάμε",
            "hero-platform": "macOS Monterey+ \u00b7 Apple Silicon Native + Intel \u00b7 VST3 host",
...
defineSiteLocale("ar", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "مألوف على السطح. جذري في العمق.",
        "hero-manifesto-copy-1": "يأخذ Taype اللغة المألوفة لاستوديو التسجيل ويعيد بناءها لعالم ما بعد التقنية. لقد اتُخذت القرارات الهندسية الحاسمة مسبقاً، كي تتمكن من التركيز على صنع التسجيل.",
        "hero-manifesto-copy-2": "يعتمد نهج freeze-first مع الآلات البرمجية والمادية، حيث تكون بيانات MIDI مضمنة في المقطع الصوتي وقريبة دائماً. وقد صُمم ليتصل بانفتاح مع أدوات الجيل التالي الأخرى، بدلاً من أن يحل محل العنصر البشري.",
...
defineSiteLocale("zh-cn", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "表面熟悉，内里激进。",
        "hero-manifesto-copy-1": "Taype 沿用录音棚里熟悉的语言，并为后技术时代重新构建它。关键的工程决策已预先完成，让你可以专注于完成唱片。",
        "hero-manifesto-copy-2": "对于软件和硬件乐器，它采用 freeze-first 的方式，将 MIDI 嵌入音频片段，始终触手可及。它也被设计为与其他下一代工具开放连接，而不是取代人的作用。",
        "hero-cta": "开始录吧",
...
defineSiteLocale("ko-kr", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "겉은 익숙하게. 속은 근본적으로.",
        "hero-manifesto-copy-1": "Taype는 녹음 스튜디오의 익숙한 언어를 가져와 포스트 테크니컬 세계에 맞게 다시 구축합니다. 중요한 엔지니어링 결정은 미리 내려져 있으므로, 사용자는 음반을 만드는 데 집중할 수 있습니다.",
        "hero-manifesto-copy-2": "소프트웨어와 하드웨어 악기에 freeze-first 접근 방식을 적용해 MIDI를 오디오 클립 안에 내장하고 언제든 가까이 둘 수 있습니다. 또한 인간적인 요소를 대체하는 대신 다른 차세대 도구와 열린 방식으로 연결되도록 설계되었습니다.",
        "hero-cta": "녹음 시작",
