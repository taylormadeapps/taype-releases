...
const DOWNLOAD_URL = "https://github.com/taylormadeapps/taype-releases/releases/download/v1.4.0/Taype-1.4.0.pkg";
...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "nav-saying": "They say",
            "nav-made-in-taype": "Made in Taype",
            "nav-download-link": "Get TayPE",
            "hero-descriptor": "Multitrack DAW for macOS",
            "hero-tagline-text": "Craft first. Accessible by design.",
            "hero-manifesto-heading": "Familiar on the surface.\nRadical underneath.",
            "hero-manifesto-copy-1": "The DAW TayPE takes the familiar language of the analogue recording studio and rebuilds it for a digital world. The critical engineering decisions have been made ahead of time, so things sound alive straight out of the box. You can focus on making the record, not spelunking through panels and menus.",
            "hero-manifesto-copy-2": "TayPE takes an audio-first approach to software and hardware instruments, with the MIDI embedded in the audio clip, always close at hand should a quick do-over be required. And it’s designed to connect openly with other intelligent tools, rather than attempting to replace the human element.",
            "hero-cta": "Let's Roll",
            ...
            "affiliate-consent-copy": "This is an affiliate link. With your permission, Lemon Squeezy will use a cookie and a device-derived identifier for 90 days so the person who referred you can receive 20% commission if you buy TayPE. It costs you nothing.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Works made in TayPE.",
            "made-in-taype-credit": "Mixed in TayPE with Vanessa",
            "made-in-taype-album-link": "Get the album →",
            "made-in-taype-listen": "Listen on YouTube Music →",
            "made-in-taype-more": "See the catalogue →",
            "saying-heading": "They say",
            "saying-quote": "\u201cWhen I don\u2019t feel like using a DAW, I use Taype.\u201d",
            "saying-name": "Charles Goodan",
            "saying-credits-label": "Credits",
            "saying-credits": "Santana, Dust Brothers, The Rolling Stones, Beck, Fight Club, Hanson, Linkin Park, Morphine, Scissors for Lefty, Harper Simon, Garfunkel and Oates",
            "saying-credit": "Grammy, Album of the Year \u2014 Supernatural by Santana, Producer",
        ...
        attrs: {
            ...
            "made-in-taype-cover": { alt: "Cover of INstruMENTALITY Vol. 1 by The Rugged" },
            "saying-photo": { alt: "Charles Goodan" }
        },
        gregisms: [
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "表面は親しみやすく。\n内側は革新的。",
            "hero-manifesto-copy-1": "DAWのTayPEは、アナログのレコーディングスタジオでおなじみの言葉を受け継ぎ、デジタルの世界に向けて組み直します。重要なエンジニアリング上の判断はあらかじめ済ませてあるので、使い始めたその瞬間から生き生きとした音が鳴ります。パネルやメニューの奥を探し回ることなく、レコード作りに集中できます。",
            "hero-manifesto-copy-2": "TayPEはソフトウェア音源にもハードウェア音源にも、オーディオを中心としたアプローチを取ります。MIDIはオーディオクリップに埋め込まれているので、さっとやり直したいときもすぐ手に取れます。そして、人間の役割を置き換えようとするのではなく、ほかのインテリジェントなツールと開かれた形でつながるよう設計されています。",
            "hero-cta": "さあ始めよう",
            ...
            "affiliate-consent-copy": "これはアフィリエイトリンクです。許可すると、Lemon Squeezy が Cookie と端末から生成した識別子を90日間使用し、TayPE を購入した場合に紹介者が20%のコミッションを受け取れるようにします。あなたの支払額は変わりません。",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "TayPEで作られた作品。",
            "made-in-taype-credit": "VanessaとTayPEでミックス",
            "made-in-taype-album-link": "アルバムを入手 →",
            "made-in-taype-listen": "YouTube Musicで聴く →",
            "made-in-taype-more": "カタログを見る →",
            "saying-heading": "声",
        ...
        html: {
            "a11y-copy": "<strong>クラフトにはアクセスが要る。</strong> <strong>アクセシビリティは機能ではない。土台だ。</strong>インターフェースはミュージシャンの居場所まで届かなければならないから。TayPEは全体でWCAG 2.2 AAを目指す。コントラスト比15:1+のハイコントラストモード。すべての状態は形とアイコンで伝え、色だけに頼らない。すべての操作にキーボードショートカット。視覚に頼らないワークフローでは、ClaudeまたはCodex経由のMCPが主要インターフェース - 音声コントロール対応。ネイティブのスクリーンリーダー対応は2026年第4四半期 / 2027年第1四半期に登場予定。",
        },
        attrs: {
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familier en surface.\nRadical en profondeur.",
            "hero-manifesto-copy-1": "Le DAW TayPE reprend le langage familier du studio d’enregistrement analogique et le reconstruit pour un monde numérique. Les décisions d’ingénierie essentielles ont été prises en amont, pour que le son soit vivant dès la première utilisation. Vous pouvez vous concentrer sur le disque, sans explorer les profondeurs des panneaux et des menus.",
            "hero-manifesto-copy-2": "TayPE adopte une approche centrée sur l’audio pour les instruments logiciels et matériels, avec le MIDI intégré au clip audio, toujours à portée de main si une reprise rapide s’impose. Et il est conçu pour se connecter ouvertement à d’autres outils intelligents, plutôt que de tenter de remplacer l’élément humain.",
            ...
            "affiliate-consent-copy": "Ceci est un lien d’affiliation. Avec votre accord, Lemon Squeezy utilisera un cookie et un identifiant dérivé de votre appareil pendant 90 jours afin que la personne qui vous a recommandé TayPE puisse recevoir une commission de 20 % si vous l’achetez. Cela ne vous coûte rien.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Des œuvres faites dans TayPE.",
            "made-in-taype-credit": "Mixé dans TayPE avec Vanessa",
            "made-in-taype-album-link": "Obtenir l'album →",
            "made-in-taype-listen": "Écouter sur YouTube Music →",
            "made-in-taype-more": "Voir le catalogue →",
            "saying-heading": "Ils disent",
    ...
    "de-de": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Vertraut an der Oberfläche.\nRadikal darunter.",
            "hero-manifesto-copy-1": "Die DAW TayPE nimmt die vertraute Sprache des analogen Aufnahmestudios und baut sie für eine digitale Welt neu auf. Die entscheidenden technischen Entscheidungen sind bereits getroffen, damit es von Anfang an lebendig klingt. Du kannst dich darauf konzentrieren, die Platte zu machen, statt dich durch die Tiefen von Bedienfeldern und Menüs zu wühlen.",
            "hero-manifesto-copy-2": "TayPE verfolgt bei Software- und Hardware-Instrumenten einen Audio-first-Ansatz: Das MIDI bleibt im Audioclip eingebettet und jederzeit griffbereit, wenn etwas schnell neu eingespielt werden soll. Und TayPE ist dafür gemacht, sich offen mit anderen intelligenten Tools zu verbinden, statt zu versuchen, den menschlichen Faktor zu ersetzen.",
            "hero-cta": "Los geht's",
            ...
            "affiliate-consent-copy": "Dies ist ein Affiliate-Link. Mit deiner Zustimmung verwendet Lemon Squeezy 90 Tage lang ein Cookie und eine aus deinem Gerät abgeleitete Kennung, damit die Person, die dich auf TayPE aufmerksam gemacht hat, beim Kauf 20 % Provision erhält. Für dich entstehen keine zusätzlichen Kosten.",
            ...
            "community-heading": "Community & Support",
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Werke, gemacht in TayPE.",
            "made-in-taype-credit": "In TayPE gemischt mit Vanessa",
            "made-in-taype-album-link": "Album holen →",
            "made-in-taype-listen": "Auf YouTube Music anhören →",
            "made-in-taype-more": "Zum Katalog →",
            "saying-heading": "Man sagt",
    ...
    "es-es": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familiar en la superficie.\nRadical por dentro.",
            "hero-manifesto-copy-1": "El DAW TayPE toma el lenguaje familiar del estudio de grabación analógico y lo reconstruye para un mundo digital. Las decisiones técnicas fundamentales ya están tomadas, para que todo suene vivo desde el primer momento. Puedes concentrarte en hacer el disco, sin explorar las profundidades de paneles y menús.",
            "hero-manifesto-copy-2": "TayPE da prioridad al audio al trabajar con instrumentos de software y hardware, con el MIDI integrado en el clip de audio, siempre a mano si hace falta repetir algo rápidamente. Y está diseñado para conectarse abiertamente con otras herramientas inteligentes, en lugar de intentar sustituir el elemento humano.",
            "hero-cta": "A grabar",
            ...
            "affiliate-consent-copy": "Este es un enlace de afiliado. Con tu permiso, Lemon Squeezy utilizará una cookie y un identificador derivado de tu dispositivo durante 90 días para que la persona que te recomendó TayPE pueda recibir una comisión del 20 % si lo compras. No te cuesta nada.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Obras hechas en TayPE.",
            "made-in-taype-credit": "Mezclado en TayPE con Vanessa",
            "made-in-taype-album-link": "Consigue el álbum →",
            "made-in-taype-listen": "Escuchar en YouTube Music →",
            "made-in-taype-more": "Ver el catálogo →",
            "saying-heading": "Dicen",
    ...
    "is-is": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Kunnuglegt á yfirborðinu.\nRóttækt undir niðri.",
            "hero-manifesto-copy-1": "TayPE tekur kunnuglegt tungumál hliðræna upptökuversins og endurbyggir það fyrir stafrænan heim. Mikilvægu tæknilegu ákvarðanirnar hafa þegar verið teknar, svo hljóðið lifnar við strax frá byrjun. Þú getur einbeitt þér að því að gera plötuna í stað þess að kafa um stjórnborð og valmyndir.",
            "hero-manifesto-copy-2": "TayPE setur hljóðið í fyrsta sæti þegar unnið er með hugbúnaðarhljóðfæri og vélbúnaðarhljóðfæri. MIDI er innbyggt í hljóðbútinn og alltaf við höndina ef endurtaka þarf eitthvað í flýti. Og TayPE er hannað til að tengjast öðrum snjöllum verkfærum á opinn hátt, í stað þess að reyna að koma í stað mannlega þáttarins.",
            "hero-cta": "Til verks",
            ...
            "affiliate-consent-copy": "Þetta er samstarfshlekkur. Með leyfi þínu notar Lemon Squeezy vefköku og auðkenni sem dregið er af tækinu þínu í 90 daga svo sá sem vísaði þér á TayPE geti fengið 20% þóknun ef þú kaupir. Þetta kostar þig ekkert.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Verk gerð í TayPE.",
            "made-in-taype-credit": "Blandað í TayPE með Vanessu",
            "made-in-taype-album-link": "Sækja plötuna →",
            "made-in-taype-listen": "Hlusta á YouTube Music →",
            "made-in-taype-more": "Sjá safnið →",
            "saying-heading": "Sagt",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Vertrouwd aan de buitenkant.\nRadicaal vanbinnen.",
            "hero-manifesto-copy-1": "De DAW TayPE neemt de vertrouwde taal van de analoge opnamestudio en bouwt die opnieuw op voor een digitale wereld. De cruciale technische beslissingen zijn al genomen, zodat alles meteen levendig klinkt. Je kunt je richten op het maken van de plaat, zonder door de krochten van panelen en menu’s te struinen.",
            "hero-manifesto-copy-2": "TayPE kiest voor een audio-first-aanpak voor software- en hardware-instrumenten, met de MIDI ingebed in de audioclip, altijd binnen handbereik als er snel iets over moet. En TayPE is ontworpen om open verbinding te maken met andere intelligente tools, in plaats van te proberen het menselijke element te vervangen.",
            ...
            "affiliate-consent-copy": "Dit is een affiliatelink. Met jouw toestemming gebruikt Lemon Squeezy 90 dagen lang een cookie en een van je apparaat afgeleide identificatiecode, zodat degene die je naar TayPE verwees 20% commissie kan ontvangen als je TayPE koopt. Het kost jou niets.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Werken gemaakt in TayPE.",
            "made-in-taype-credit": "Gemixt in TayPE met Vanessa",
            "made-in-taype-album-link": "Haal het album →",
            "made-in-taype-listen": "Luister op YouTube Music →",
            "made-in-taype-more": "Bekijk de catalogus →",
            "saying-heading": "Ze zeggen",
    ...
    "it-it": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Familiare in superficie.\nRadicale dentro.",
            "hero-manifesto-copy-1": "La DAW TayPE prende il linguaggio familiare dello studio di registrazione analogico e lo ricostruisce per un mondo digitale. Le decisioni tecniche cruciali sono già state prese, così il suono è vivo fin dal primo utilizzo. Puoi concentrarti sul fare il disco, senza avventurarti nei meandri di pannelli e menu.",
            "hero-manifesto-copy-2": "TayPE adotta un approccio che mette l’audio al primo posto per gli strumenti software e hardware, con il MIDI incorporato nella clip audio, sempre a portata di mano se serve rifare qualcosa al volo. Ed è progettato per collegarsi apertamente ad altri strumenti intelligenti, invece di tentare di sostituire l’elemento umano.",
            "hero-cta": "Si parte",
            ...
            "affiliate-consent-copy": "Questo è un link di affiliazione. Con il tuo permesso, Lemon Squeezy utilizzerà un cookie e un identificatore derivato dal dispositivo per 90 giorni, così chi ti ha consigliato TayPE potrà ricevere una commissione del 20% se lo acquisti. Per te non cambia il prezzo.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Opere fatte in TayPE.",
            "made-in-taype-credit": "Mixato in TayPE con Vanessa",
            "made-in-taype-album-link": "Prendi l'album →",
            "made-in-taype-listen": "Ascolta su YouTube Music →",
            "made-in-taype-more": "Vedi il catalogo →",
            "saying-heading": "Dicono",
    ...
    "pl-pl": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Znajome na powierzchni.\nRadykalne pod spodem.",
            "hero-manifesto-copy-1": "DAW TayPE bierze znajomy język analogowego studia nagraniowego i buduje go od nowa dla cyfrowego świata. Kluczowe decyzje techniczne zostały już podjęte, dzięki czemu dźwięk od razu tętni życiem. Możesz skupić się na tworzeniu płyty, zamiast przekopywać się przez zakamarki paneli i menu.",
            "hero-manifesto-copy-2": "TayPE stawia audio na pierwszym miejscu w pracy z instrumentami programowymi i sprzętowymi. MIDI jest osadzone w klipie audio i zawsze pozostaje pod ręką, gdy trzeba coś szybko nagrać ponownie. TayPE zaprojektowano też do otwartej współpracy z innymi inteligentnymi narzędziami, zamiast do zastępowania czynnika ludzkiego.",
            "hero-cta": "Zaczynamy",
            ...
            "affiliate-consent-copy": "To jest link partnerski. Za Twoją zgodą Lemon Squeezy będzie przez 90 dni używać pliku cookie i identyfikatora utworzonego na podstawie urządzenia, aby osoba polecająca TayPE mogła otrzymać 20% prowizji, jeśli kupisz program. Nie ponosisz żadnych dodatkowych kosztów.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Dzieła stworzone w TayPE.",
            "made-in-taype-credit": "Zmiksowane w TayPE z Vanessą",
            "made-in-taype-album-link": "Zdobądź album →",
            "made-in-taype-listen": "Słuchaj na YouTube Music →",
            "made-in-taype-more": "Zobacz katalog →",
            "saying-heading": "Mówią",
    ...
    "uk-ua": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Знайомий зовні.\nРадикальний усередині.",
            "hero-manifesto-copy-1": "DAW TayPE бере знайому мову аналогової студії звукозапису й перебудовує її для цифрового світу. Ключові технічні рішення вже прийняті заздалегідь, тож звук оживає із самого початку. Ви можете зосередитися на створенні запису, а не блукати нетрями панелей і меню.",
            "hero-manifesto-copy-2": "TayPE ставить аудіо на перше місце в роботі з програмними й апаратними інструментами. MIDI вбудовано в аудіокліп, тож воно завжди під рукою, якщо потрібно швидко щось перезаписати. А ще TayPE створено для відкритої взаємодії з іншими інтелектуальними інструментами, а не для спроб замінити людський елемент.",
            "hero-cta": "Поїхали",
            ...
            "affiliate-consent-copy": "Це партнерське посилання. З вашого дозволу Lemon Squeezy протягом 90 днів використовуватиме файл cookie та ідентифікатор, створений на основі даних пристрою, щоб людина, яка порадила вам TayPE, могла отримати 20% комісії, якщо ви придбаєте програму. Для вас це нічого не коштує.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Роботи, зроблені в TayPE.",
            "made-in-taype-credit": "Зведено в TayPE з Vanessa",
            "made-in-taype-album-link": "Отримати альбом →",
            "made-in-taype-listen": "Слухати на YouTube Music →",
            "made-in-taype-more": "Переглянути каталог →",
            "saying-heading": "Кажуть",
    ...
    "el-gr": {
        ...
        text: {
            ...
            "hero-manifesto-heading": "Οικείο στην επιφάνεια.\nΡιζοσπαστικό από κάτω.",
            "hero-manifesto-copy-1": "Το DAW TayPE παίρνει την οικεία γλώσσα του αναλογικού στούντιο ηχογράφησης και την ξαναχτίζει για έναν ψηφιακό κόσμο. Οι κρίσιμες τεχνικές αποφάσεις έχουν ληφθεί εκ των προτέρων, ώστε ο ήχος να είναι ζωντανός από την πρώτη στιγμή. Μπορείτε να επικεντρωθείτε στη δημιουργία του δίσκου, αντί να εξερευνάτε τα βάθη των πάνελ και των μενού.",
            "hero-manifesto-copy-2": "Το TayPE δίνει προτεραιότητα στον ήχο τόσο για τα εικονικά όσο και για τα φυσικά όργανα, με το MIDI ενσωματωμένο στο κλιπ ήχου και πάντα διαθέσιμο, αν χρειαστεί να ξαναγράψετε κάτι στα γρήγορα. Και έχει σχεδιαστεί για να συνδέεται ανοιχτά με άλλα ευφυή εργαλεία, αντί να επιχειρεί να αντικαταστήσει τον ανθρώπινο παράγοντα.",
            "hero-cta": "Ξεκινάμε",
            "hero-platform": "macOS Monterey+ \u00b7 Apple Silicon Native + Intel \u00b7 VST3 host",
            ...
            "affiliate-consent-copy": "Αυτός είναι σύνδεσμος συνεργάτη. Με την άδειά σας, η Lemon Squeezy θα χρησιμοποιήσει ένα cookie και ένα αναγνωριστικό που προκύπτει από τη συσκευή σας για 90 ημέρες, ώστε το άτομο που σας πρότεινε το TayPE να λάβει προμήθεια 20% αν το αγοράσετε. Δεν σας κοστίζει τίποτα.",
            ...
            "made-in-taype-heading": "Made in Taype",
            "made-in-taype-copy": "Έργα φτιαγμένα στο TayPE.",
            "made-in-taype-credit": "Μιξαρισμένο στο TayPE με τη Vanessa",
            "made-in-taype-album-link": "Απόκτησε το άλμπουμ →",
            "made-in-taype-listen": "Άκου στο YouTube Music →",
            "made-in-taype-more": "Δες τον κατάλογο →",
            "saying-heading": "Λένε",
...
defineSiteLocale("ar", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "مألوف على السطح.\nجذري في العمق.",
        "hero-manifesto-copy-1": "يأخذ برنامج DAW TayPE اللغة المألوفة لاستوديو التسجيل التناظري ويعيد بناءها لعالم رقمي. لقد اتُخذت القرارات الهندسية الحاسمة مسبقاً، ليكون الصوت نابضاً بالحياة من أول استخدام. يمكنك التركيز على صنع التسجيل، بدلاً من التنقيب في أعماق اللوحات والقوائم.",
        "hero-manifesto-copy-2": "يعطي TayPE الأولوية للصوت عند العمل مع الآلات البرمجية والمادية، مع تضمين بيانات MIDI في المقطع الصوتي لتبقى دائماً في متناول اليد إذا احتجت إلى إعادة التسجيل بسرعة. وقد صُمم ليتصل بانفتاح مع أدوات ذكية أخرى، بدلاً من محاولة أن يحل محل العنصر البشري.",
        ...
        "affiliate-consent-copy": "هذا رابط تابع. بإذنك، ستستخدم Lemon Squeezy ملف تعريف ارتباط ومعرّفًا مشتقًا من جهازك لمدة 90 يومًا، حتى يحصل الشخص الذي عرّفك على TayPE على عمولة قدرها 20% إذا اشتريته. لن يكلفك ذلك شيئًا.",
        ...
        "made-in-taype-heading": "Made in Taype",
        "made-in-taype-copy": "أعمال صُنعت في TayPE.",
        "made-in-taype-credit": "مُزج في TayPE مع Vanessa",
        "made-in-taype-album-link": "احصل على الألبوم ←",
        "made-in-taype-listen": "استمع على YouTube Music ←",
        "made-in-taype-more": "اطلع على الكتالوج ←",
        "saying-heading": "يقولون",
...
defineSiteLocale("zh-cn", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "表面熟悉，\n内里激进。",
        "hero-manifesto-copy-1": "DAW TayPE 沿用模拟录音棚里熟悉的语言，并为数字世界重新构建它。关键的工程决策已预先完成，让声音从一开始就充满活力。你可以专注于完成唱片，而不必在面板和菜单的深处四处摸索。",
        "hero-manifesto-copy-2": "TayPE 以音频为先来处理软件和硬件乐器，将 MIDI 嵌入音频片段，始终触手可及，方便随时快速重录。它也被设计为与其他智能工具开放连接，而不是试图取代人的作用。",
        "hero-cta": "开始录吧",
        ...
        "affiliate-consent-copy": "这是一个联盟推广链接。经你同意，Lemon Squeezy 将使用 Cookie 和由设备信息生成的标识符保存 90 天；如果你购买 TayPE，推荐人可获得 20% 的佣金。你无需支付任何额外费用。",
        ...
        "made-in-taype-heading": "Made in Taype",
        "made-in-taype-copy": "在 TayPE 中完成的作品。",
        "made-in-taype-credit": "在 TayPE 中与 Vanessa 一起混音",
        "made-in-taype-album-link": "获取专辑 →",
        "made-in-taype-listen": "在 YouTube Music 收听 →",
        "made-in-taype-more": "查看目录 →",
        "saying-heading": "他们说",
    ...
    html: {
        "a11y-copy": "<strong>创作需要可访问。</strong> <strong>可访问性不是一个功能，而是基础。</strong> 因为界面必须在音乐人所在的地方与他们相遇。TayPE 全面以 WCAG 2.2 AA 为目标。高对比模式提供 15:1+ 文本比例。每一种状态都用形状和图标表达，从不只靠颜色。每个操作都有键盘快捷键。对于非视觉工作流，MCP 通过 Claude 或 Codex 是主要界面 - 包括语音控制。原生屏幕阅读器支持将于 2026 年第四季度 / 2027 年第一季度推出。",
    },
    attrs: {
...
defineSiteLocale("ko-kr", {
    ...
    text: {
        ...
        "hero-manifesto-heading": "겉은 익숙하게.\n속은 근본적으로.",
        "hero-manifesto-copy-1": "DAW TayPE는 아날로그 녹음 스튜디오의 익숙한 언어를 가져와 디지털 세계에 맞게 다시 구축합니다. 중요한 엔지니어링 결정은 미리 내려져 있으므로, 처음부터 생생한 사운드를 들을 수 있습니다. 패널과 메뉴 깊숙한 곳을 헤매는 대신 음반을 만드는 데 집중할 수 있습니다.",
        "hero-manifesto-copy-2": "TayPE는 소프트웨어와 하드웨어 악기 모두에 오디오를 우선하는 접근 방식을 적용합니다. MIDI는 오디오 클립 안에 내장되어 있어 빠르게 다시 녹음해야 할 때 언제든 꺼내 쓸 수 있습니다. 또한 인간적인 요소를 대체하려 하기보다 다른 지능형 도구와 열린 방식으로 연결되도록 설계되었습니다.",
        "hero-cta": "녹음 시작",
        ...
        "affiliate-consent-copy": "이 링크는 제휴 링크입니다. 동의하면 Lemon Squeezy가 쿠키와 기기 정보에서 생성된 식별자를 90일 동안 사용합니다. TayPE를 구매할 경우 추천한 사람이 20% 수수료를 받을 수 있으며, 구매자에게 추가 비용은 없습니다.",
        ...
        "made-in-taype-heading": "Made in Taype",
        "made-in-taype-copy": "TayPE에서 만든 작품.",
        "made-in-taype-credit": "Vanessa와 함께 TayPE에서 믹스",
        "made-in-taype-album-link": "앨범 받기 →",
        "made-in-taype-listen": "YouTube Music에서 듣기 →",
        "made-in-taype-more": "목록 보기 →",
        "saying-heading": "말들",
