...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "If Melodyne is installed, pitch editing is available wherever you need it. Open any clip and start working — no dedicated tracks, plugin management or setup ritual. TayPE also includes the “Industry Standard” keybinding profile for producers whose wetware is already mapped to Pro Tools.",
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "Melodyneがインストールされていれば、必要な場所でピッチ編集が使えます。任意のクリップを開いて作業開始 — 専用トラックも、プラグイン管理も、準備儀式も不要。TayPEには、Pro Toolsに手癖がすでに結び付いているプロデューサー向けの「Industry Standard」キー割り当てプロファイルも含まれます。",
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "Si Melodyne est installé, l’édition de hauteur est disponible partout où vous en avez besoin. Ouvrez n’importe quel clip et commencez à travailler — pas de pistes dédiées, de gestion de plugins ou de rituel de configuration. TayPE inclut aussi le profil de raccourcis « Industry Standard » pour les producteurs dont le wetware est déjà mappé sur Pro Tools.",
    ...
    "es-es": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "Si Melodyne está instalado, la edición de afinación está disponible donde la necesites. Abre cualquier clip y empieza a trabajar — sin pistas dedicadas, gestión de plugins ni ritual de configuración. TayPE también incluye el perfil de atajos «Industry Standard» para productores cuyo wetware ya está mapeado a Pro Tools.",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "Als Melodyne is geïnstalleerd, is pitchbewerking beschikbaar waar je die nodig hebt. Open elke clip en begin te werken — geen speciale tracks, pluginbeheer of setup-ritueel. TayPE bevat ook het toetsprofiel “Industry Standard” voor producers wier wetware al aan Pro Tools is gekoppeld.",
    ...
    "it-it": {
        ...
        text: {
            ...
            "arranger-flow-copy-3": "Se Melodyne è installato, l’editing dell’intonazione è disponibile ovunque serva. Apri qualunque clip e inizia a lavorare — niente tracce dedicate, gestione plugin o rituale di setup. TayPE include anche il profilo di scorciatoie “Industry Standard” per producer il cui wetware è già mappato su Pro Tools.",
