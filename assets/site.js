...
const locales = {
    "en-gb": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Our DAW, TayPE, takes the familiar language of the recording studio and rebuilds it for a post-technical world. The critical engineering decisions have been made ahead of time, so you can focus on making the record.",
    ...
    "ja-jp": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "私たちのDAW、TayPEは、レコーディングスタジオでおなじみの言葉を受け継ぎ、ポストテクニカルな世界のために組み直します。重要なエンジニアリング上の判断はあらかじめ済ませてあるので、あなたはレコード作りに集中できます。",
    ...
    "fr-fr": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Notre DAW, TayPE, reprend le langage familier du studio d’enregistrement et le reconstruit pour un monde post-technique. Les décisions d’ingénierie essentielles ont été prises en amont, afin que vous puissiez vous concentrer sur le disque.",
    ...
    "de-de": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Unsere DAW TayPE nimmt die vertraute Sprache des Aufnahmestudios und baut sie für eine posttechnische Welt neu auf. Die entscheidenden technischen Entscheidungen sind bereits getroffen, damit du dich darauf konzentrieren kannst, die Platte zu machen.",
    ...
    "es-es": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Nuestro DAW, TayPE, toma el lenguaje familiar del estudio de grabación y lo reconstruye para un mundo postécnico. Las decisiones críticas de ingeniería ya están tomadas, para que puedas concentrarte en hacer el disco.",
    ...
    "is-is": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "DAW-ið okkar, TayPE, tekur kunnuglegt tungumál upptökuversins og endurbyggir það fyrir heim handan tækninnar. Mikilvægu verkfræðilegu ákvarðanirnar hafa verið teknar fyrirfram, svo þú getir einbeitt þér að því að gera plötuna.",
    ...
    "nl-nl": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Onze DAW, TayPE, neemt de vertrouwde taal van de opnamestudio en bouwt die opnieuw op voor een posttechnische wereld. De cruciale technische beslissingen zijn vooraf genomen, zodat jij je kunt richten op het maken van de plaat.",
    ...
    "it-it": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "La nostra DAW, TayPE, prende il linguaggio familiare dello studio di registrazione e lo ricostruisce per un mondo post-tecnico. Le decisioni tecniche cruciali sono già state prese, così puoi concentrarti sul fare il disco.",
    ...
    "pl-pl": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Nasz DAW, TayPE, bierze znajomy język studia nagraniowego i buduje go od nowa dla posttechnicznego świata. Kluczowe decyzje inżynieryjne zostały podjęte z wyprzedzeniem, aby można było skupić się na tworzeniu płyty.",
    ...
    "uk-ua": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Наша DAW, TayPE, бере знайому мову студії звукозапису й перебудовує її для посттехнічного світу. Критичні інженерні рішення вже прийняті заздалегідь, тож ви можете зосередитися на створенні запису.",
    ...
    "el-gr": {
        ...
        text: {
            ...
            "hero-manifesto-copy-1": "Το DAW μας, το TayPE, παίρνει την οικεία γλώσσα του στούντιο ηχογράφησης και την ξαναχτίζει για έναν μετα-τεχνικό κόσμο. Οι κρίσιμες μηχανικές αποφάσεις έχουν ληφθεί εκ των προτέρων, ώστε να μπορείτε να επικεντρωθείτε στη δημιουργία του δίσκου.",
...
defineSiteLocale("ar", {
    ...
    text: {
        ...
        "hero-manifesto-copy-1": "يأخذ برنامجنا DAW، TayPE، اللغة المألوفة لاستوديو التسجيل ويعيد بناءها لعالم ما بعد التقنية. لقد اتُخذت القرارات الهندسية الحاسمة مسبقاً، كي تتمكن من التركيز على صنع التسجيل.",
...
defineSiteLocale("zh-cn", {
    ...
    text: {
        ...
        "hero-manifesto-copy-1": "我们的 DAW——TayPE——沿用录音棚里熟悉的语言，并为后技术时代重新构建它。关键的工程决策已预先完成，让你可以专注于完成唱片。",
...
defineSiteLocale("ko-kr", {
    ...
    text: {
        ...
        "hero-manifesto-copy-1": "우리의 DAW인 TayPE는 녹음 스튜디오의 익숙한 언어를 가져와 포스트 테크니컬 세계에 맞게 다시 구축합니다. 중요한 엔지니어링 결정은 미리 내려져 있으므로, 사용자는 음반을 만드는 데 집중할 수 있습니다.",
